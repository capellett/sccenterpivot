---
title: "Irrigated Areas 2009-2018"
...
```{r zones}
i_zones0 <- sf::st_read(
  "DNR-irrigationZones//irrigation_zones.shp") %>%
...
```{r}
pivot_pts0 <- sf::st_read("DNR-irrigationZones//pivot_points.shp") # %>%
...
i_joins0 <- sf::st_read(
  "DNR-irrigationZones//irrigation_pipes.shp",
